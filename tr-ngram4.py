...
logging.basicConfig(format='%(asctime)s %(message)s', filename='tr-ngram4.log', level=logging.INFO)
...
if not os.path.abspath(filesDirName):
        ...
        logging.debug("The corpus folder %s does not exist" %fileDirName)
        raise Exception(exception)
...
#change the value of n for trigram
n = 3
...
while 1:
	...
	file1_text_p = [n_grams for n_grams in ngrams(file1_text_p, n)]
	...
	file2_text_p = [n_grams for n_grams in ngrams(file2_text_p, n)]
